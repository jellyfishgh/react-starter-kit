((React, render) => {
    ...
    const JQueryMobileButton = React.createClass({
    ...
    const JQueryMobileContent = React.createClass({
        displayName: 'JQueryMobileContent',
        render() {
            return (
                <div role='main' className='ui-content'>{this.props.children}</div>
            );
        }
    });

    /** jQuery Mobile footer component. */
    const JQueryMobileFooter = React.createClass({
    ...
    const JQueryMobileHeader = React.createClass({
    ...
    const JQueryMobilePage = React.createClass({
    ...
    const PageOneContent = React.createClass({
    ...
    const PageTwoContent = React.createClass({
    ...
    const PagePopUpContent = React.createClass({
