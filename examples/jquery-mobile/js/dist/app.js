...
var JQueryMobileButton = React.createFactory(React.createClass({
...
var JQueryMobileFooter = React.createFactory(React.createClass({
...
var JQueryMobileHeader = React.createFactory(React.createClass({
...
var JQueryMobilePage = React.createFactory(React.createClass({
...
var PageOneContent = React.createFactory(React.createClass({
...
var PageTwoContent = React.createFactory(React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                JQueryMobileButton,
                { href: '#one', 'data-direction': 'reverse', calssName: 'ui-btn ui-shadow ui-corner-all ui-btn-b' },
                'Back to page "one"'
            )
        );
    }
...
var PagePopUpContent = React.createFactory(React.createClass({
